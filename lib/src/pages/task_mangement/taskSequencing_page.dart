...
import '../../components/task_sequencing/body.dart';
import '../../config/style/constants.dart';

class TaskSequencingPage extends StatelessWidget {
...
class TaskSequencingExercisePage extends StatelessWidget {
  TaskSequencingExercisePage({Key? key}) : super(key: key);
  final TaskSequencingExerciseController _questionController =
